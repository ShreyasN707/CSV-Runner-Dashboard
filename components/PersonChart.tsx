  ...
  return (
    <div className="space-y-2 sm:space-y-3 animate-fade-in h-full flex flex-col">
      <div className="grid gap-2 sm:gap-3 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        <Card className="transition-all duration-300 hover:shadow-md border-l-4 border-l-[#3B82F6] bg-gradient-to-br from-card via-card/98 to-card/95 backdrop-blur-sm group shadow-sm">
        ...
        <Card className="transition-all duration-300 hover:shadow-md border-l-4 border-l-[#06B6D4] bg-gradient-to-br from-card via-card/98 to-card/95 backdrop-blur-sm group shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 px-3 sm:px-4 pt-2.5 sm:pt-3">
        ...
        <Card className="transition-all duration-300 hover:shadow-md border-l-4 border-l-[#10B981] bg-gradient-to-br from-card via-card/98 to-card/95 backdrop-blur-sm group shadow-sm sm:col-span-2 md:col-span-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 px-3 sm:px-4 pt-2.5 sm:pt-3">
